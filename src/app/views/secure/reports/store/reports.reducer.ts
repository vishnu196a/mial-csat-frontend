...
export function reportsReducer(state = initialState, action: ReportsActions): ReportsState {
  switch (action.type) {
    case ReportsActionTypes.SET_PAGINATION:
      return {
        ...state,
        pagination: { ...action.payload },
      };
    case ReportsActionTypes.SET_CURRENT_PAGE:
      return {
        ...state,
        pagination: { ...state.pagination, current_page: action.payload },
      };
    case ReportsActionTypes.SET_PER_PAGE:
      return { ...state, pagination: { ...state.pagination, per_page: action.payload } };
    case ReportsActionTypes.SET_GLOBAL_SEARCH:
      return { ...state, globalSearch: action.payload };
    case ReportsActionTypes.SET_COLUMN_SEARCH:
      return {
        ...state,
